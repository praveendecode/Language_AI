    ...
    def sentiment_analysis(self):
        ...
        with st.sidebar:  # Navbar
            selected = option_menu(
                ...
                options=['Intro', "Sentiment Analysis", "Language Translator",'Speech Synthesis', 'Summarization','Table Question Answering System','Question Answering System','Feedback'],
                icons=['mic-fill', '', '', '', ''],
                menu_icon='alexa',
                default_index=0,
            )
